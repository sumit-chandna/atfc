$(document).ready(function () {
            ...
            $('#searchFlightbtn').click(function(e){
            	...
            	if( !($('#roundTrip').is(':checked') || $('#onewayTrip').is(':checked'))){
            	...
            	if($('#adultCount').val()==0 ){
            		errorMessage='Please select atleast one Adult ';
            		valid=false;
            	}
            	if($('#infantCount').val()>$('#adultCount').val()){
            		errorMessage='The number of infants cannot be greater than that of adults ';
            		valid=false;
            	}
